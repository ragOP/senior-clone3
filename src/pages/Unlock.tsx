...
export default function Unlock() {
  ...
  useEffect(() => {
    window.document.title = "Seniors Beneifit";
      ...
      {step === "process" ? (
       ...
       Seniors On Medicare Can Unlock Their Food Allowance Worth Up To $900!
            ...
            <div style={{marginTop:'-5px'}} className="survey">
              ...
              <div  className=
              "answer">
              {quiz === "Select Your Age:  " && <div className="answer-btn-5" onClick={handleQuizPos} style={{"textTransform": "capitalize"}}>
              {fourth}
                </div>}
                <div className="answer-btn-5" onClick={handleQuizPos}>
              {yes}
                </div>
                <div className="answer-btn-5" onClick={handleQuizNeg}>
              {no}
                </div>
               <div className="answer-btn-5" onClick={handleQuizPos}>
              {third}
